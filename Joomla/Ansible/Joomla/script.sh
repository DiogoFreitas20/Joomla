...
<IfModule mod_ssl.c>
        <VirtualHost _default_:443>
                ...
                #   Similarly, one has to force some clients to use HTTP/1.0 to workaround                #   their broken HTTP/1.1 implementation. Use variables "downgrade-1.0" and
...
sudo echo Seguro > /var/www/htmls/index.html

sudo rm /var/www/html/index.html
sudo echo Nao Seguro > /var/www/html/index.html
